...
Rails.application.configure do
  ...
  # config.action_controller.asset_host = 'https://assets.countrify.net'
  ...
  # config.active_job.queue_name_prefix = "countryfier_#{Rails.env}"
  ...
  config.action_mailer.default_url_options = { host: 'countrify.net' }
